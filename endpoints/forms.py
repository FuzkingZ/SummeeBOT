...
class message_msgForm(forms.ModelForm):
    class Meta:
        model = message_msg
        fields = ['from_mid', 'to_mid', 'deliveredTime', 'text', 'location', 'hasContent', 'contentType', 'contentPreview', 'contentMetadata', 'sessionId', 'chunks', 'relatedMessageId', 'messageRelationType', 'readCount', 'relatedMessageServiceCode', 'result_code', 'result_msg', 'msgid']
...
class timelineForm(forms.ModelForm):
    class Meta:
        model = timeline
        fields = ['name', 'timelineid', 'text',  'stickerID', 'packageID']# 'picture'
